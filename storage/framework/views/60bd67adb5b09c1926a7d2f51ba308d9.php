        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('capacitaciones.cursos.index')); ?>">Cursos</a></li>
    ...
    <form id="cursoEditForm" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titulo" name="titulo" 
                                   value="<?php echo e(old('titulo', $curso->titulo)); ?>" required maxlength="200">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="4" 
                                     placeholder="Describe el contenido y objetivos del curso..."><?php echo e(old('descripcion', $curso->descripcion)); ?></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php if($curso->imagen_portada): ?>
                                <div class="mt-3" id="imagen-current">
                                    ...
                                    <img src="<?php echo e($curso->imagen_portada_url); ?>" alt="Imagen actual" 
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="form-control" id="id_area" name="id_area" required>
                                ...
                                <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($area->id); ?>" 
                                            <?php echo e(old('id_area', $curso->id_area) == $area->id ? 'selected' : ''); ?>>
                                        <?php echo e($area->descripcion); ?> (<?php echo e($area->categoria->descripcion); ?>)
                                    </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="instructor_id" name="instructor_id" required>
                                ...
                                <?php $__currentLoopData = $creadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($creador->id); ?>" 
                                            <?php echo e(old('instructor_id', $curso->instructor_id) == $creador->id ? 'selected' : ''); ?>>
                                        <?php echo e($creador->name); ?> <?php echo e($creador->apellido1); ?> (<?php echo e($creador->role); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <div class="invalid-feedback"></div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="estado" name="estado" required>
                                <option value="borrador" <?php echo e(old('estado', $curso->estado) == 'borrador' ? 'selected' : ''); ?>>Borrador</option>
                                <option value="activo" <?php echo e(old('estado', $curso->estado) == 'activo' ? 'selected' : ''); ?>>Activo</option>
                                <option value="finalizado" <?php echo e(old('estado', $curso->estado) == 'finalizado' ? 'selected' : ''); ?>>Finalizado</option>
                                <option value="archivado" <?php echo e(old('estado', $curso->estado) == 'archivado' ? 'selected' : ''); ?>>Archivado</option>
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="codigo_acceso" name="codigo_acceso" 
                                       value="<?php echo e(old('codigo_acceso', $curso->codigo_acceso)); ?>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="fecha_inicio" name="fecha_inicio" 
                                   value="<?php echo e(old('fecha_inicio', $curso->fecha_inicio ? $curso->fecha_inicio->format('Y-m-d\TH:i') : '')); ?>">
                            <div class="invalid-feedback"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="fecha_fin" name="fecha_fin" 
                                   value="<?php echo e(old('fecha_fin', $curso->fecha_fin ? $curso->fecha_fin->format('Y-m-d\TH:i') : '')); ?>">
                            <div class="invalid-feedback"></div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="max_estudiantes" name="max_estudiantes" 
                                           ...
                                           value="<?php echo e(old('max_estudiantes', $curso->max_estudiantes)); ?>">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="duracion_horas" name="duracion_horas" 
                                           min="1" value="<?php echo e(old('duracion_horas', $curso->duracion_horas)); ?>">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="objetivos" name="objetivos" rows="5" 
                                     placeholder="¿Qué aprenderán los estudiantes?"><?php echo e(old('objetivos', $curso->objetivos)); ?></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="requisitos" name="requisitos" rows="5" 
                                     placeholder="¿Qué conocimientos previos se necesitan?"><?php echo e(old('requisitos', $curso->requisitos)); ?></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="nota_minima_aprobacion" name="nota_minima_aprobacion" 
                                   value="<?php echo e(old('nota_minima_aprobacion', $curso->nota_minima_aprobacion ?? 3.0)); ?>" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="progress" style="height: 30px;">
                                <div class="progress-bar <?php echo e($porcentajeTotal > 100 ? 'bg-danger' : 'bg-success'); ?>" 
                                     role="progressbar" id="porcentaje-asignado-bar" 
                                     style="width: <?php echo e(min($porcentajeTotal, 100)); ?>%;" 
                                     aria-valuenow="<?php echo e($porcentajeTotal); ?>" aria-valuemin="0" aria-valuemax="100">
                                    <span id="porcentaje-asignado-text"><?php echo e(number_format($porcentajeTotal, 1)); ?>%</span>
                                </div>
                            </div>
                            <small class="form-text text-muted">
                                Materiales: <?php echo e(number_format($porcentajeMateriales, 1)); ?>% | 
                                Actividades: <?php echo e(number_format($porcentajeActividades, 1)); ?>%
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Creado:</strong> <?php echo e($curso->created_at->format('d/m/Y H:i')); ?></p>
                        <p><strong>Última actualización:</strong> <?php echo e($curso->updated_at->format('d/m/Y H:i')); ?></p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Estudiantes inscritos:</strong> <?php echo e($curso->estudiantes_count ?? 0); ?></p>
                        <p><strong>Código de acceso:</strong> <code><?php echo e($curso->codigo_acceso); ?></code></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body" id="materiales-container">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $materiales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="material-item mb-3 p-3 border rounded" data-material-id="<?php echo e($material->id); ?>">
                        <div class="row align-items-center">
                            <div class="col-md-1 text-center">
                                <i class="<?php echo e($material->tipo_icon); ?> fa-2x text-primary"></i>
                            </div>
                            <div class="col-md-7">
                                <h5 class="mb-1"><?php echo e($material->titulo); ?></h5>
                                <p class="text-muted mb-1"><?php echo e($material->descripcion); ?></p>
                                <small class="text-muted">
                                    <?php echo $material->tipo_badge; ?> • 
                                    <?php if($material->archivo_size): ?>
                                        <?php echo e($material->archivo_size_formatted); ?> • 
                                    <?php endif; ?>
                                    Subido <?php echo e($material->created_at->diffForHumans()); ?>
                            ...
                            <div class="col-md-4 text-right">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" 
                                        onclick="verDocumento(<?php echo e(json_encode($archivoUrl)); ?>, <?php echo e(json_encode($material->titulo)); ?>, <?php echo e(json_encode($material->tipo)); ?>, <?php echo e(json_encode($extension)); ?>)">
                                    <i class="fas fa-eye"></i> Ver
                                </button>
                                
                                <button type="button" class="btn btn-warning btn-sm btn-editar-material" 
                                        data-material-id="<?php echo e($material->id); ?>">
                                    <i class="fas fa-edit"></i> Editar
                                </button>
                                
                                <button type="button" class="btn btn-danger btn-sm" onclick="eliminarMaterial(<?php echo e($material->id); ?>)">
        ...
        <div class="card">
            ...
            <div class="card-body" id="actividades-container">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="actividad-item mb-3 p-3 border rounded" data-actividad-id="<?php echo e($actividad->id); ?>">
                        <div class="row align-items-center">
                            <div class="col-md-1 text-center">
                                <?php
                                    $iconos = [
                                ...
                                ?>
                                <i class="<?php echo e($iconos[$actividad->tipo] ?? 'fas fa-tasks text-secondary'); ?> fa-2x"></i>
                            </div>
                            <div class="col-md-6">
                                <h5 class="mb-1"><?php echo e($actividad->titulo); ?></h5>
                                <p class="text-muted mb-1"><?php echo e(Str::limit($actividad->descripcion, 100)); ?></p>
                                <small class="text-muted">
                                    <?php echo $actividad->tipo_badge; ?> • 
                                    <?php echo e($actividad->puntos_maximos); ?> puntos •
                                    <?php if($actividad->fecha_apertura): ?>
                                        Apertura: <?php echo e($actividad->fecha_apertura->format('d/m/Y H:i')); ?>

                                    <?php endif; ?>
                                    <?php if($actividad->fecha_cierre): ?>
                                        • Cierre: <?php echo e($actividad->fecha_cierre->format('d/m/Y H:i')); ?>

                                    <?php endif; ?>
                                </small>
                            </div>
                            <div class="col-md-2 text-center">
                                <?php if(in_array($actividad->tipo, ['quiz', 'evaluacion'])): ?>
                                    <span class="badge badge-<?php echo e($actividad->habilitado ? 'success' : 'secondary'); ?>">
                                        <?php echo e($actividad->habilitado ? 'Habilitado' : 'Deshabilitado'); ?>

                                    </span>
                                    <?php if($actividad->contenido_json && isset($actividad->contenido_json['questions'])): ?>
                                        <br><small class="text-muted"><?php echo e(count($actividad->contenido_json['questions'])); ?> preguntas</small>
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <div class="col-md-3 text-right">
                                <button type="button" class="btn btn-primary btn-sm" onclick="editarActividad(<?php echo e($actividad->id); ?>)">
                                    <i class="fas fa-edit"></i> Editar
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" onclick="eliminarActividad(<?php echo e($actividad->id); ?>)">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="btn-group float-left">
                            <a href="<?php echo e(route('capacitaciones.cursos.index')); ?>" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Volver a la Lista
                            </a>
                            <a href="<?php echo e(route('capacitaciones.cursos.classroom', $curso->id)); ?>" class="btn btn-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="edit_prerequisite_id" name="prerequisite_id">
                                        ...
                                        <?php $__currentLoopData = $materiales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($mat->id); ?>" data-material-id="<?php echo e($mat->id); ?>">
                                                <?php echo e($mat->titulo); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#cursoEditForm').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("capacitaciones.cursos.update", $curso->id)); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = '<?php echo e(route("capacitaciones.cursos.classroom", $curso->id)); ?>';
                                } else {
            ...
            $('#subirMaterialForm').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("capacitaciones.cursos.classroom.materiales.store", $curso->id)); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            window.eliminarMaterial = function(materialId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/capacitaciones/cursos/<?php echo e($curso->id); ?>/classroom/materiales/${materialId}`,
                            type: 'DELETE',
                            data: {
            ...
            $(document).on('click', '.btn-editar-material', function() {
                ...
                $.ajax({
                    url: '/capacitaciones/cursos/<?php echo e($curso->id); ?>/classroom/materiales/' + materialId + '/obtener',
                    type: 'GET',
                    success: function(response) {
                        Swal.close();
            ...
            window.editarActividad = function(actividadId) {
                ...
                window.location.href = `/capacitaciones/cursos/<?php echo e($curso->id); ?>/classroom#actividades`;
            };
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SHC\resources\views/admin/capacitaciones/cursos/edit.blade.php ENDPATH**/ ?>