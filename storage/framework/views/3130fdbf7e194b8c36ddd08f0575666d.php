...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <span <?php if(config('adminlte.usermenu_image')): ?> class="d-none d-md-inline" <?php endif; ?>>
            <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->apellido1 ?? ''); ?> <?php echo e(Auth::user()->apellido2 ?? ''); ?>
...
<?php /**PATH C:\xampp\htdocs\SHC\resources\views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>