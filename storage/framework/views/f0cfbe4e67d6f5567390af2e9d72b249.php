...
<?php $__env->startSection('title', 'Editor de Certificados'); ?>
                            ...
                            <select class="form-control form-control-sm mt-2" id="selectUsuario">
                                ...
                                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($usuario->id); ?>"
                                            ...
                                            data-apellido1="<?php echo e($usuario->apellido1); ?>"
                                            data-apellido2="<?php echo e($usuario->apellido2); ?>"
                                            data-documento="<?php echo e($usuario->numero_documento); ?>">
                            ...
                            <select class="form-control form-control-sm mt-2" id="selectCurso">
                                ...
                                <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($curso->id); ?>"
                                            ...
                                            data-duracion="<?php echo e($curso->duracion_horas); ?>"
                                            data-fecha-inicio="<?php echo e($curso->fecha_inicio ? $curso->fecha_inicio->format('Y-m-d') : ''); ?>"
                                            data-fecha-fin="<?php echo e($curso->fecha_fin ? $curso->fecha_fin->format('Y-m-d') : ''); ?>">
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SHC\resources\views/admin/configuracion/editor-certificados/index.blade.php ENDPATH**/ ?>