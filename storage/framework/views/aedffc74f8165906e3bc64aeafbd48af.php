<?php $__env->startSection('title', $curso->titulo . ' - Classroom'); ?>

<?php $__env->startSection('content_header'); ?>
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h1><i class="fas fa-chalkboard-teacher"></i> <?php echo e($curso->titulo); ?></h1>
                <p class="text-muted mb-0">
                    <i class="fas fa-layer-group"></i> <?php echo e($curso->area_descripcion); ?> • 
                    <i class="fas fa-user-tie"></i> <?php echo e($curso->instructor_nombre); ?> • 
                    <i class="fas fa-users"></i> <?php echo e($curso->estudiantes_count); ?> estudiantes
                </p>
            </div>
            <div class="col-sm-4">
                <div class="float-sm-right">
                    <a href="<?php echo e(route('capacitaciones.cursos.index')); ?>" class="btn btn-secondary mb-2">
                ...
                <ol class="breadcrumb float-sm-right" style="clear: both;">
                    ...
                    <li class="breadcrumb-item active"><?php echo e($curso->titulo); ?></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card card-widget widget-user">
        <div class="widget-user-header text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 200px; position: relative;">
            <?php if($curso->imagen_portada): ?>
                <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-image: url('<?php echo e($curso->imagen_portada_url); ?>'); background-size: cover; background-position: center; opacity: 0.3;"></div>
            <?php endif; ?>
            <div style="position: relative; z-index: 1;">
                <h3 class="widget-user-username"><?php echo e($curso->titulo); ?></h3>
                <h5 class="widget-user-desc"><?php echo e($curso->area_descripcion); ?></h5>
                <p class="mt-3"><?php echo e($curso->descripcion); ?></p>
                
                <div class="row mt-4">
                    <div class="col-md-3 col-6">
                        <div class="description-block border-right">
                            <span class="description-percentage text-white"><i class="fas fa-users"></i></span>
                            <h5 class="description-header text-white"><?php echo e($curso->estudiantes_count); ?></h5>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="description-block border-right">
                            ...
                            <h5 class="description-header text-white"><?php echo e($curso->materiales->count()); ?></h5>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="description-block border-right">
                            ...
                            <h5 class="description-header text-white"><?php echo e($curso->actividades->count()); ?></h5>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="description-block">
                            ...
                            <h5 class="description-header text-white"><?php echo e($curso->foros->count()); ?></h5>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-sm-6">
                    <div class="description-block">
                        <h5 class="description-header"><?php echo e($curso->codigo_acceso); ?></h5>
                        <span class="description-text">CÓDIGO DE ACCESO</span>
                    </div>
                </div>
                <div class="col-sm-6">
                    <?php if(!$esEstudiante && !$esInstructor): ?>
                    ...
                    <?php elseif($esEstudiante): ?>
                        <div class="progress float-right" style="width: 200px; margin-top: 10px;">
                            <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo e($progreso); ?>%" aria-valuenow="<?php echo e($progreso); ?>" aria-valuemin="0" aria-valuemax="100">
                                <?php echo e($progreso); ?>% Completado
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="materiales-tab" data-toggle="pill" href="#materiales" role="tab" aria-controls="materiales" aria-selected="false">
                        <i class="fas fa-folder-open"></i> Materiales <span class="badge badge-info"><?php echo e($curso->materiales->count()); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="foros-tab" data-toggle="pill" href="#foros" role="tab" aria-controls="foros" aria-selected="false">
                        <i class="fas fa-comments"></i> Foros <span class="badge badge-primary"><?php echo e($curso->foros->count()); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="actividades-tab" data-toggle="pill" href="#actividades" role="tab" aria-controls="actividades" aria-selected="false">
                        <i class="fas fa-tasks"></i> Actividades <span class="badge badge-warning"><?php echo e($curso->actividades->count()); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="participantes-tab" data-toggle="pill" href="#participantes" role="tab" aria-controls="participantes" aria-selected="false">
                        <i class="fas fa-users"></i> Participantes <span class="badge badge-success"><?php echo e($curso->estudiantes_count + 1); ?></span>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php $__empty_1 = true; $__currentLoopData = $curso->foros->where('es_anuncio', true)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anuncio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="post">
                                            <div class="user-block">
                                                <i class="fas fa-user-circle fa-2x text-secondary" style="margin-right: 10px;"></i>
                                                <span class="username">
                                                    <a href="#"><?php echo e($anuncio->usuario_nombre); ?></a>
                                                    <span class="badge badge-warning">Anuncio</span>
                                                </span>
                                                <span class="description"><?php echo e($anuncio->fecha_formateada); ?></span>
                                            </div>
                                            <h5><?php echo e($anuncio->titulo); ?></h5>
                                            <p><?php echo e(Str::limit($anuncio->contenido, 200)); ?></p>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php $__empty_1 = true; $__currentLoopData = $curso->actividades->where('estado', 'abierta')->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="info-box">
                                            <span class="info-box-icon bg-info"><i class="<?php echo e($actividad->tipo_icon); ?>"></i></span>
                                            <div class="info-box-content">
                                                <span class="info-box-text"><?php echo e($actividad->titulo); ?></span>
                                                <span class="info-box-number"><?php echo e($actividad->tiempo_restante); ?></span>
                                                <div class="progress">
                                                    <div class="progress-bar bg-info" style="width: 70%"></div>
                                                </div>
                                                <span class="progress-description">
                                                    Fecha límite: <?php echo e($actividad->fecha_cierre_formateada); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        <?php if($curso->duracion_horas): ?>
                                            <?php echo e($curso->duracion_horas); ?> horas académicas
                                        <?php else: ?>
                                            No especificada
                                        <?php endif; ?>
                                    </p>
                                    ...
                                    <p class="text-muted">
                                        <strong>Inicio:</strong> <?php echo e($curso->fecha_inicio ? $curso->fecha_inicio->format('d/m/Y') : 'No definida'); ?><br>
                                        <strong>Fin:</strong> <?php echo e($curso->fecha_fin ? $curso->fecha_fin->format('d/m/Y') : 'No definida'); ?>
                                    ...
                                    <?php if($curso->objetivos): ?>
                                        ...
                                        <p class="text-muted"><?php echo e($curso->objetivos); ?></p>
                                        <hr>
                                    <?php endif; ?>

                                    <?php if($curso->requisitos): ?>
                                        <strong><i class="fas fa-list-check mr-1"></i> Requisitos</strong>
                                        <p class="text-muted"><?php echo e($curso->requisitos); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="progress mb-3">
                                            <div class="progress-bar bg-primary progress-bar-striped" role="progressbar" style="width: <?php echo e($progreso); ?>%" aria-valuenow="<?php echo e($progreso); ?>" aria-valuemin="0" aria-valuemax="100">
                                                <?php echo e($progreso); ?>%
                                            </div>
                                        </div>
                                        <small class="text-muted">
                                            Has completado <?php echo e($progreso); ?>% del curso
                                        </small>
                                    </div>
                                </div>
                            <?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        window.cursoId = <?php echo e($curso->id); ?>;
        ...
        $(document).ready(function() {
            ...
            $('#btn-inscribirse').click(function() {
                Swal.fire({
                    ...
                    text: "Te inscribirás en: <?php echo e($curso->titulo); ?>",
                    icon: 'question',
                    showCancelButton: true,
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route("capacitaciones.cursos.classroom.inscribir", $curso->id)); ?>',
                            type: 'POST',
                            data: {
        ...
        window.loadTabContent = function(tabName, target) {
            ...
            const urls = {
                'materiales': '<?php echo e(route("capacitaciones.cursos.classroom.materiales", $curso->id)); ?>?v=' + timestamp,
                'foros': '<?php echo e(route("capacitaciones.cursos.classroom.foros", $curso->id)); ?>?v=' + timestamp,
                'actividades': '<?php echo e(route("capacitaciones.cursos.classroom.actividades", $curso->id)); ?>?v=' + timestamp,
                'participantes': '<?php echo e(route("capacitaciones.cursos.classroom.participantes", $curso->id)); ?>?v=' + timestamp
            };
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SHC\resources\views/admin/capacitaciones/cursos/classroom/index.blade.php ENDPATH**/ ?>