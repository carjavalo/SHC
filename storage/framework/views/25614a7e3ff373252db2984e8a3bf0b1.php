...
<head>
    ...
    <title><?php echo e($subject ?? 'Notificación'); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        <!-- Marca de agua con logo -->
        <div class="watermark">
            <img src="<?php echo e(asset('images/logocorreo.jpeg')); ?>" alt="Logo HUV">
        </div>
        
        <!-- Header -->
        <div class="email-header">
            <img src="<?php echo e(asset('images/logocorreo.jpeg')); ?>" alt="Logo Hospital Universitario del Valle">
        ...
        <div class="email-footer">
            ...
            <div class="contact-info">
                ...
                <p>&copy; <?php echo e(date('Y')); ?> Hospital Universitario del Valle. Todos los derechos reservados.</p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\SHC\resources\views/emails/layout.blade.php ENDPATH**/ ?>