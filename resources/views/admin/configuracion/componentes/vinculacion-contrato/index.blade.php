...
@section('title', 'Gestión de Vinculación/Contrato')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><i class="fas fa-file-contract"></i> Gestión de Vinculación/Contrato</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Vinculación/Contrato</li>
            </ol>
        </div>
    </div>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-table"></i> Lista de Vinculación/Contrato</h3>
            <div class="card-tools">
                <button type="button" class="btn btn-success" id="btn-nuevo">
                    <i class="fas fa-plus"></i> Nueva Vinculación/Contrato
                </button>
            </div>
        </div>
        <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="itemModalLabel">Nueva Vinculación/Contrato</h4>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="viewModalLabel">
                        <i class="fas fa-eye"></i> Detalles de Vinculación/Contrato
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-muted"><i class="fas fa-file-contract"></i> <strong>Nombre:</strong></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#data-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '{{ route("configuracion.componentes.vinculacion-contrato.data") }}',
                    data: function(d) {
                        d.nombre = $('#nombre').val();
                    }
                },
            ...
            $('#btn-nuevo').click(function() {
                $('#itemForm')[0].reset();
                $('#item_id').val('');
                $('#itemModalLabel').text('Nueva Vinculación/Contrato');
            ...
            $('#itemForm').submit(function(e) {
                ...
                var url = itemId ?
                    '{{ route("configuracion.componentes.vinculacion-contrato.update", ":id") }}'.replace(':id', itemId) :
                    '{{ route("configuracion.componentes.vinculacion-contrato.store") }}';
            ...
            window.viewItem = function(id) {
                $.get('{{ route("configuracion.componentes.vinculacion-contrato.show", ":id") }}'.replace(':id', id))
                    .done(function(data) {
            ...
            window.editItem = function(id) {
                $.get('{{ route("configuracion.componentes.vinculacion-contrato.edit", ":id") }}'.replace(':id', id))
                    .done(function(data) {
                        $('#item_id').val(data.id);
                        $('#modal_nombre').val(data.nombre);
                        $('#itemModalLabel').text('Editar Vinculación/Contrato');
            ...
            window.deleteItem = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route("configuracion.componentes.vinculacion-contrato.destroy", ":id") }}'.replace(':id', id),
                            method: 'DELETE',
